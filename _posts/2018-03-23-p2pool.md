...
```
Edit the script to match your setup:<br />
`PUBLIC_IP` your public IP address<br />
`EMAIL` your email address<br />
`PAYOUT_ADDRESS` your AXE wallet address to receive fees<br />
`USER_NAME` linux user name<br />
`RPCUSER` enter a random alphanumeric rpc user name<br />
`RPCPASSWORD` enter a random alphanumeric rpc password<br />
